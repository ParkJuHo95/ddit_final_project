  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item" style="position: relative;">
      <a href="<%=request.getContextPath()%>/user/eworks" class="menu-link">
        ...
        <span data-i18n="Account Settings">전자결재</span> <span class="badge badge-center rounded-pill bg-primary" style="position: absolute; right: 15px;" id="sdcBadge">${sdcNum }</span>
      </a>
    </li>
    ...
    <li class="menu-item">
      ...
      <a href="<%=request.getContextPath()%>/user/community/chat" class="menu-link">
        ...
        <div data-i18n="Layouts">커뮤니케이션</div>
      </a>
    </li>
