     ...
     <div class="nav-align-top">
      ...
      <div class="tab-content">
        <div class="tab-pane fade active show" id="job-rank-settings" role="tabpanel">
          <div class="col">
			<button type="button" class="btn btn-icon btn-outline-primary createBtn" data-form-id="psa">
		  ...
		  <div class="col-md-7 mb-3 table-responsive text-nowrap">
			  <form:form modelAttribute="psa">
				  ...
				  <tr><th>구분</th><th>내용</th></tr>
					...
					<tr><td id="btnSpaceA" colspan="2" style="text-align: right;"><button type="submit" value="create" class="btn btn-primary" data-form-id="psa">등록</button></td></tr>
				  </table>
			  </form:form>
		  </div>
		  </div>
        ...
        <div class="tab-pane fade" id="job-position-settings" role="tabpanel">
          <div class="col">
				<button type="button" class="btn btn-icon btn-outline-primary createBtn" data-form-id="psb">
					<span class="tf-icons bx bx-plus"></span>
				</button>
	        </div>
	        <div class="row">
