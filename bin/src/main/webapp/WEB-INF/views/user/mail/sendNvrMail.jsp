...
<div id="inner-card-body" class="card-body" style="height: 82vh; overflow: scroll;">
	...
	<form:form id="nvrMailForm" method="post" enctype="multipart/form-data" modelAttribute="nvr"> 
		<div class="m-0 p-0">
			...
			<input type="email" class="form-control"  placeholder="이메일 주소" value="dpwhdwkd@naver.com"/> 
		</div>
		<div class="m-0 p-0">
			<label for="받는 사람" class="form-label">받는 분</label> 
			<input type="email" class="form-control"  placeholder="이메일 주소" valye='yejongha@gmail.com' /> 
		</div>
		<div class="m-0 p-0">
			<label for="메일 제목" class="form-label">제목</label>
			 <form:input type="text" class="form-control"  placeholder="제목을 입력하세요" path='nvrTitle' />
		</div>
		<div class="m-0 p-0">
		...
		<div class="m-0 p-0">
			 <input type="password" class="form-control" value="Tls!tlf159" style="display: none;" />
		</div>
